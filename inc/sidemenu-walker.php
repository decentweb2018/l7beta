 ...
 * WP Custom Walker
 *
 * @package WP-Custom-Walker
 */
/*
 * Class Name: WP_Custom_Walker
 * Plugin Name: WP Custom Walker
 * Version: 1.0.0
 * License: GPL-3.0+
	...
	class WP_Custom_Walker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			*/
			...
			if ( isset( $args->has_children ) && $args->has_children ) {
				$output .= $indent . '<li role="menuitem" aria-haspopup="true" itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement"' . $id . $class_names . '>';
			}else{
			...
			//Add start block for submenu
			if ( isset( $args->has_children ) && $args->has_children ) {
				$submenu_start = "<div class=\"sub-nav\">
								<header class=\"sub-nav-header\">
									<a href=\"#0\" class=\"close-sub-nav\" aria-hidden=\"false\" tabindex=\"0\"></a>
									<span class=\"sub-nav-title\" id=\"nav-group-title-$title\">
                                        $title
                                    </span>
								</header>
